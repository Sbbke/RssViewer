...
/**
 * Renders in the main pane once a topic is selected in the sidebar.
 * Re-fetches whenever topicId changes (see the useEffect dependency
 * array) — switching topics in the sidebar should always show fresh
 * data, unlike the old dropdown which only fetched once per topic.
 */
